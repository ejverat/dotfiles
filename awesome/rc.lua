...
if has_freedesktop then
	...
	mymainmenu = awful.menu({ items = { { "awesome", myawesomemenu, beautiful.awesome_icon }, menu_terminal } })
end
...
awful.screen.connect_for_each_screen(function(s)
	...
	s.tags[7].layout = awful.layout.layouts[9]
...
globalkeys = gears.table.join(
	...
	awful.key({ modkey }, "c", function()
		cw.toggle()
	end, { description = "Show/hide calendar", group = "global" }),

	awful.key({ modkey }, "d", function()
		local home_dir = "/home/" .. user
		local value = home_dir .. "/.screenlayout/default-2-screens.sh"
		awful.spawn.with_shell(value)
	end, { description = "Reload display settings", group = "global" })
)
...
globalkeys = awful.util.table.join(
	...
	awful.key({ modkey }, "y", function()
		kbdcfg.switch_next()
	end, { description = "Change keyboard layout", group = "global" })
...
awful.rules.rules = {
	...
	{
		rule_any = {
			class = { "Microsoft Teams - Preview", "FFPWA-01H0NT82TSW25QSQV674T06ZCN" },
			instance = { "microsoft teams - preview", "FFPWA-01H0NT82TSW25QSQV674T06ZCN" },
		},
		properties = {
